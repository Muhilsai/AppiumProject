...
public class Swipe {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		driver.hideKeyboard();
		//driver.findElement(MobileBy.AndroidUIAutomator("UiSelector().text(\"Doodling in math: Connecting dots\")")).click();
		//driver.findElement(MobileBy.AndroidUIAutomator("UiSelector().text(\"Doodling in math: Connecting dots\")")).isDisplayed();
		...
		driver.findElement(MobileBy.AccessibilityId("Screenshot")).click();
		//screenshot will come out of the notification screen, so the following code will fail
		driver.findElement(MobileBy.AndroidUIAutomator("UiSelector().text(\"Google\")")).click();
		driver.pressKey(new KeyEvent(AndroidKey.BACK));
		driver.pressKey(new KeyEvent(AndroidKey.HOME));
		*/
		driver.findElement(MobileBy.AccessibilityId("Mute,Off")).click();
		driver.pressKey(new KeyEvent(AndroidKey.BACK));
		driver.pressKey(new KeyEvent(AndroidKey.HOME));
	}
